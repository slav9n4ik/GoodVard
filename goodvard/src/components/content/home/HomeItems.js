...
import kidsImg from "../../../img/kids-baner-bg-back.png";
...
export default [
    {
        id: 0,
        title: 'Защита детей от скучного английского',
        explanation: 'Ваш ребенок полюбит наш английский',
        src: mainImg,
        srcBg: mainImgBg
    },
    {
    ...
    },
    {
        ...
        explanation: 'Игровой формат занятий с элементами театра',
        src: preschoolImg,
