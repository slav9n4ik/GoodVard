...
jQuery(document).ready(function() {
	...
	$("#btn-scroll").on("click","a", function (event) {
	        //отменяем стандартную обработку нажатия по ссылке04
	        event.preventDefault();
	...
	/*Scroll to footer*/
	$(function(){
		$('.clikblock').click(function(){$('html,body').animate({scrollTop:10000}, 1100);});
	});
	
	/*Price click*/	    
$('#book1').on("click", function () {
		var el = document.getElementById('message');
		el.value = 'Здраствуйте, хотим записаться в группу для дошкольников!';

	});
$('#book2').on("click", function () {
		var el = document.getElementById('message');
		el.value = 'Здраствуйте, хотим записаться в группу для школьников!';

	});
$('#book3').on("click", function () {
		var el = document.getElementById('message');
		el.value = 'Здраствуйте, хотим записаться в детский сад!';

	});
$('#book4').on("click", function () {
		var el = document.getElementById('message');
		el.value = 'Здраствуйте, хотим записаться на индивидуальные занятия!';
	});
